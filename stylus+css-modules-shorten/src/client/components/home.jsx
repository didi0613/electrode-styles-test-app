...
class Home extends React.Component {
  ...
  render() {
    return (
      <div>
        <section styleName={"custom.login-box"}>
          <header styleName={"custom.login-header"}>
            <svg
              styleName={"custom.login-icon"}
            ...
            <h2>
              ...
              <a styleName={"custom.login-sign"} href="#sign">
                Sign up
              </a>
            </h2>
          </header>
          <div styleName={"custom.login-content"}>
            <input styleName={"custom.login-mail"} type="mail" placeholder="E-mail Address" />
            <input styleName={"custom.login-pass"} type="password" placeholder="Password" />
            <a styleName={"custom.login-forgot"} href="#forgot">
              Forgot password?
            </a>
            <button styleName={"custom.login-enter"}>Log in </button>
          </div>
        </section>
      </div>
    );
