...
class Home extends React.Component {
  ...
  render() {
    return (
      <div>
        <section className={custom["login-box"]}>
          <header className={custom["login-header"]}>
            ...
            <h2>
              ...
              <a className={custom["login-sign"]} href="#sign">
                Sign up
              </a>
            </h2>
          </header>
          <div className={custom["login-content"]}>
            <input className={custom["login-mail"]} type="mail" placeholder="E-mail Address" />
            <input className={custom["login-pass"]} type="password" placeholder="Password" />
            <a className={custom["login-forgot"]} href="#forgot">
              Forgot password?
            </a>
            <button className={custom["login-enter"]}>Log in </button>
          </div>
        </section>
      </div>
    );
